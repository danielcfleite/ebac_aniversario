...
var contaAsHoras = setInterval(function () {
  ...
  var diasAteOEvento = Math.floor(distanciaAteOEvento / (1000 * 60 * 60 * 24));
  var horasAteOEvento = Math.floor(distanciaAteOEvento % (1000 * 60 * 60 * 24) / (1000 * 60 * 60));
  var minutosAteOEvento = Math.floor(distanciaAteOEvento % (1000 * 60 * 60) / (1000 * 60));
  var segundosAteOEvento = Math.floor(distanciaAteOEvento % (1000 * 60) / 1000);
  contador.innerHTML = "".concat(diasAteOEvento, "d ").concat(horasAteOEvento, "h ").concat(minutosAteOEvento, "m ").concat(segundosAteOEvento, "s");
